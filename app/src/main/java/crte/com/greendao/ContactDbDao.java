...
public class ContactDbDao extends AbstractDao<ContactDb, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, ContactDb entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ContactDb entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(ContactDb entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(ContactDb entity) {
